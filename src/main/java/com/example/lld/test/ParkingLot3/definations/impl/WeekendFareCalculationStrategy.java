...
public class WeekendFareCalculationStrategy implements FareCalculationStrategy {
    @Override
    public BigDecimal calculatePrice(Ticket ticket) {
        ...
        return new BigDecimal(elapsedSeconds).multiply(new BigDecimal(spotSize)).multiply(new BigDecimal("1.5"));
    }
